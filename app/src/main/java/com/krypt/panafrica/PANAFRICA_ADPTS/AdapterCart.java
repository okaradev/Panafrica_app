package com.krypt.panafrica.PANAFRICA_ADPTS;


import static com.krypt.panafrica.utils.Urls.URL_REMOVE_ITEM;
import static com.krypt.panafrica.utils.Urls.URL_UPDATE_CART;
...
import com.krypt.panafrica.PANAFRICAMODELS.ProductModal;
import com.krypt.panafrica.MainActivity;
...
//                    .centerCrop()
//                    .into(view.image);
           view.title.setText("Goods :" + p.getProductName());
           view.txv_stock.setText(p.getWeight() + "Kgs");

            view.price.setText("Kshs "+p.getPrice());
            //x5view.txv_subTotal.setText("Subtotal: Kshs " + p.getSubToatl());
