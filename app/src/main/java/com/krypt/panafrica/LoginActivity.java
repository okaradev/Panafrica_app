...
import static com.krypt.panafrica.utils.Urls.URL_LOGIN;
...
import com.krypt.panafrica.Users.Staff.Dashboard;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void select(View v) {
        ...
        final String[] array = {"Customer", "Finance", "Service manager","Dispatch manager", "Driver", "Operations manager","Tracking cordinator"};
