package com.krypt.panafrica.utils;

public class Urls {


    public static String ipAddress = "http://panafrica.blupayinc.com/";
    //public static String ipAddress = "http://192.168.137.196/panafricalogistics/";
    ...
    public static final String URL_SEN_FEEDBACK = ROOT_URL + "supervisor/senfed.php";
    public static final String URL_BACK = ROOT_URL + "supervisor/getfed.php";
    public static final String URL_SENF_FEEDBACK = ROOT_URL + "finance/senfed.php";
    public static final String URL_FBACK = ROOT_URL + "finance/getfed.php";
    //Staff
    //Staff
